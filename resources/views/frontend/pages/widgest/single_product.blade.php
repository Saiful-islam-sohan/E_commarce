            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            <div class="item">
                                <img src="{{ asset('uplodes/product_photos') }}/{{ $product->product_image }}" alt="">
                            </div>

                            @foreach ($product->productImages as $image)
                            <div class="item">
                                <img src="{{ asset('uplodes/product_photos') }}/{{ $image->product_multiple_image }}" alt="">
                            </div>
                            @endforeach
                ...
                <div class="col-lg-6">
                    <div class="product-single-content">
                        ...
                        <ul class="cetagory">
                            <li>Categories:</li>
                            <li><a href="{{ route('shope') }}">{{ $product->category->title ?? ''}}</a></li>
                        </ul>
                        <ul class="socil-icon">
                            <li>Share :</li>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="featured-product-wrap">
                        <div class="featured-product-img">
                            <img src="{{ asset('uplodes/product_photos') }}/{{ $reproduct->product_image }}" alt="">
                        </div>
